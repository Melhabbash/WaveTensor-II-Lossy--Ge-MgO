...
h=figure;
% plot(f1_1(:,1),f1_1(:,11),f1_1(:,1),f1_2(:,11),'-. b',f1_1(:,1),f2(:,11),'-. b',f1_1(:,1),f3(:,11),'k', f1_1(:,1),f4(:,11),'k',f1_1(:,1),f5(:,11),'-- r'), grid;
plot(f1_1(:,1),f1_1(:,11),'-. b',f1_1(:,1),f3(:,11),'k',f1_1(:,1),f5(:,11),'-- r'), grid;
...
legend({'R(1-Layer-Ge)','R(3-Layers)','R(5-Layers)'},'Location','best');
...
plot(f1_1(:,1),f1_1(:,13),'-. b',f1_1(:,1),f3(:,13),'k',f1_1(:,1),f5(:,13),'-- r'), grid;
ylim([-0.5 0.6]);
...
legend({'tan(\phi_R)(1-Layer-Ge)','tan(\phi_R)(3-Layers)','tan(\phi_R)(5-Layers)'},'Location','northeast');
...
h=figure;
% plot(f1_1(:,1),f1_1(:,13),f1_1(:,1),f1_2(:,13),': g',f1_1(:,1),f2(:,13),'-. b',f1_1(:,1),f3(:,13),'k', f1_1(:,1),f4(:,13),'k',f1_1(:,1),f5(:,13),'-- r'), grid;
plot(f1_1(:,1),f1_1(:,15),'-. b',f1_1(:,1),f3(:,15),'k',f1_1(:,1),f5(:,15),'-- r'), grid;

% title(['Average{\it \phi_R} of '  K1 num2str(V) K3 'transverse voltage' ] );
xlabel('Wavelength (m)'); 
ylabel('\phi_R(\lambda)  (degree) '); 
% legend({'\phi_R(1-Layer-Ge)','\phi_R(1-Layer-CaF_2)','\phi_R(2-Layers)','\phi_R(3-Layers)','\phi_R(4-Layers)','\phi_R(5-Layers)'},'Location','bestoutside');
legend({'\phi_R(1-Layer-Ge)','\phi_R(3-Layers)','\phi_R(5-Layers)'},'Location','east');
...
h=figure;
% plot(f1_1(:,1),f1_1(:,15),f1_1(:,1),f1_2(:,15),'-. b',f1_1(:,1),f2(:,15),'-. b',f1_1(:,1),f3(:,15),'k', f1_1(:,1),f4(:,15),'k',f1_1(:,1),f5(:,15),'-- r'), grid;
plot(f1_1(:,1),f1_1(:,17),'-. b',f1_1(:,1),f3(:,17),'k',f1_1(:,1),f5(:,17),'-- r'), grid;
...
legend({'T(1-Layer-Ge)','T(3-Layers)','T(5-Layers)'},'Location','best');

saveas(h,[K4 K9 K1 num2str(V) K3 num2str(theta_0_degree) K7 ]);

h=figure;
% plot(f1_1(:,1),f1_1(:,17),f1_1(:,1),f1_2(:,17),'-. b',f1_1(:,1),f2(:,17),'-. b',f1_1(:,1),f3(:,17),'k', f1_1(:,1),f4(:,17),'k',f1_1(:,1),f5(:,17),'-- r'), grid;
plot(f1_1(:,1),f1_1(:,19),'-. b',f1_1(:,1),f3(:,19),'k', f1_1(:,1),f5(:,19),'-- r'), grid;
...
legend({'tan (\phi_R(\lambda))(1-Layer-Ge)','tan (\phi_R(\lambda))(3-Layers)','tan (\phi_R(\lambda))(5-Layers)'},'Location','best');
...
h=figure;
% plot(f1_1(:,1),f1_1(:,17),f1_1(:,1),f1_2(:,17),'-. b',f1_1(:,1),f2(:,17),'-. b',f1_1(:,1),f3(:,17),'k', f1_1(:,1),f4(:,17),'k',f1_1(:,1),f5(:,17),'-- r'), grid;
plot(f1_1(:,1),f1_1(:,21),'-. b',f1_1(:,1),f3(:,21),'k',f1_1(:,1),f5(:,21),'-- r'), grid;
...
% legend({'\phi_T(1-Layer-Ge)','\phi_T(1-Layer-CaF_2)','\phi_T(2-Layers)','\phi_T(3-Layers)','\phi_T(4-Layers)','\phi_T(5-Layers)'},'Location','bestoutside');
legend({'\phi_T(1-Layer-Ge)','\phi_T(3-Layers)','\phi_T(5-Layers)'},'Location','best');
