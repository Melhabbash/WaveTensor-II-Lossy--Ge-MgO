...
file_2_layers= '2Layers300VoltsGe-1time0degree.xlsx';
file_3_layers= '3Layers300VoltsGe-1.5time0degree.xlsx';
file_4_layers= '4Layers300VoltsGeMgO-2time0degree.xlsx';
file_5_layers= '5Layers300VoltsGeMgO-2.5time0degree.xlsx';
...
plot(f1_1(:,1),f1_1(:,11),'g',f1_1(:,1),f2(:,11),'-. b',f1_1(:,1),f3(:,11),'-- k', f1_1(:,1),f4(:,11),'k',f1_1(:,1),f5(:,11),' r'), grid;
...
legend({'R(1-Layer-Ge)','R(2-Layers)','R(3-Layers)','R(4-Layers)','R(5-Layers)'},'Location','best');
...
plot(f1_1(:,1),f1_1(:,13),'g',f1_1(:,1),f2(:,13),'-. b',f1_1(:,1),f3(:,13),'-- k', f1_1(:,1),f4(:,13),'k',f1_1(:,1),f5(:,13),' r'), grid;
ylim([-1.5 1.5]);
...
legend({'tan(\phi_R)(1-Layer-Ge)','tan(\phi_R)(2-Layers)','tan(\phi_R)(3-Layers)','tan(\phi_R)(4-Layers)','tan(\phi_R)(5-Layers)'},'Location','northeast');
...
h=figure;
% plot(f1_1(:,1),f1_1(:,13),f1_1(:,1),f1_2(:,13),': g',f1_1(:,1),f2(:,13),'-. b',f1_1(:,1),f3(:,13),'-- k', f1_1(:,1),f4(:,13),'k',f1_1(:,1),f5(:,13),' r'), grid;
plot(f1_1(:,1),f1_1(:,15),'g',f1_1(:,1),f2(:,15),'-. b',f1_1(:,1),f3(:,15),'-- k', f1_1(:,1),f4(:,15),'k',f1_1(:,1),f5(:,15),' r'), grid;

% title(['Average{\it \phi_R} of '  K1 num2str(V) K3 'transverse voltage' ] );
xlabel('Wavelength (m)'); 
ylabel('\phi_R(\lambda)  (degree) '); 
% legend({'\phi_R(1-Layer-Ge)','\phi_R(1-Layer-CaF_2)','\phi_R(2-Layers)','\phi_R(3-Layers)','\phi_R(4-Layers)','\phi_R(5-Layers)'},'Location','bestoutside');
legend({'\phi_R(1-Layer-Ge)','\phi_R(2-Layers)','\phi_R(3-Layers)','\phi_R(4-Layers)','\phi_R(5-Layers)'},'Location','northeast');
...
plot(f1_1(:,1),f1_1(:,17),'g',f1_1(:,1),f2(:,17),'-. b',f1_1(:,1),f3(:,17),'-- k', f1_1(:,1),f4(:,17),'k',f1_1(:,1),f5(:,17),' r'), grid;
...
legend({'T(1-Layer-Ge)','T(2-Layers)','T(3-Layers)','T(4-Layers)','T(5-Layers)'},'Location','best');
...
plot(f1_1(:,1),f1_1(:,19),'g',f1_1(:,1),f2(:,19),'-. b',f1_1(:,1),f3(:,19),'-- k', f1_1(:,1),f4(:,19),'k',f1_1(:,1),f5(:,19),' r'), grid;
...
legend({'tan (\phi_R(\lambda))(1-Layer-Ge)','tan (\phi_R(\lambda))(2-Layers)','tan (\phi_R(\lambda))(3-Layers)','tan (\phi_R(\lambda))(4-Layers)','tan (\phi_R(\lambda))(5-Layers)'},'Location','best');
...
h=figure;
% plot(f1_1(:,1),f1_1(:,17),f1_1(:,1),f1_2(:,17),'g',f1_1(:,1),f2(:,17),'-. b',f1_1(:,1),f3(:,17),'-- k', f1_1(:,1),f4(:,17),'k',f1_1(:,1),f5(:,17),' r'), grid;
plot(f1_1(:,1),f1_1(:,21),'g',f1_1(:,1),f2(:,21),'-. b',f1_1(:,1),f3(:,21),'-- k', f1_1(:,1),f4(:,21),'k',f1_1(:,1),f5(:,21),' r'), grid;
...
% legend({'\phi_T(1-Layer-Ge)','\phi_T(1-Layer-CaF_2)','\phi_T(2-Layers)','\phi_T(3-Layers)','\phi_T(4-Layers)','\phi_T(5-Layers)'},'Location','bestoutside');
legend({'\phi_T(1-Layer-Ge)','\phi_T(2-Layers)','\phi_T(3-Layers)','\phi_T(4-Layers)','\phi_T(5-Layers)'},'Location','best');
