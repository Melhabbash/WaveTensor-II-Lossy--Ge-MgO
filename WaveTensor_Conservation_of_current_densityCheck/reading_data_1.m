...
L(number_of_layers,(7+numel(num2str(number_of_layers))))=char(number_of_layers);
resist(number_of_layers,(18+numel(num2str(number_of_layers))))=char(number_of_layers);
thickness(number_of_layers,(16+numel(num2str(number_of_layers))))=char(number_of_layers);
dielectric_constant(number_of_layers,(26+numel(num2str(number_of_layers))))=char(number_of_layers);
effective_mass(number_of_layers,(21+numel(num2str(number_of_layers))))=char(number_of_layers);
...
for nl=1:number_of_layers/2
    
    tag=strcat(tag, Label(nl,:));
    
end
tag=strcat(tag,'-',num2str(number_of_layers/2),'time');
tag=char(tag);
end
