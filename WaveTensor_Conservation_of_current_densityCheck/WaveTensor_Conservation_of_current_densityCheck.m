...
[ Reflection, Reflection_phase ] = reflection( number_of_points,zp,zs);
...
[Transmission,Transmission_phase]=transmission (number_of_points,yp,ys);

theta_0_degree=theta_0(1)*180/pi;

Writting_Results(tag,number_of_layers,number_of_points,V,theta_0_degree,lambda_0,Mp,Ms,Rp_abs,Rp_phase,Rs_abs,Rs_phase,Reflection,Reflection_phase,Transmission,Transmission_phase,rp,tp,rs,ts,q,con);
Plotting_Rp_Rs_abs_phase(tag,lambda_0,number_of_layers,V,theta_0_degree,Rp_abs,Rp_phase,Rs_abs,Rs_phase,Reflection, Reflection_phase,Tp_abs,Tp_phase,Ts_abs,Ts_phase,Transmission,Transmission_phase);

% [inv_Mp,inv_Ms] = inv_Matrix (number_of_points,theta_0,Mp,Ms);
% [mult_p,mult_s] = multiplication_Matrix (number_of_points,theta_0,Mp,Ms,inv_Mp,inv_Ms);
[Ip,Is] = conservation_of_current_density (number_of_points,theta_0,theta,Intrinsic_impedance_Air,Intrinsic_impedance,Mp,Ms);